...
const HUBS = [
  ...
  },
  {
    id: "hub-poppies-farm",
    name: "Poppies Farm",
    estate: "A traditional small family farm",
    town: "Hurst",
    postcode: "RG10 0RS",
    region: "south-east",
    species: ["beef", "pork", "lamb", "chicken"],
    status: "open",
    buy: "Order online, or collect from the farm or a local pickup point",
    hours: "All cuts available 7 days a week",
    website: "https://www.poppiesfarm.com/butchers-shop",
    product: "Rare & Minority Native Beef, Pork and Lamb; Pasture-Reared Chicken",
    mapsQuery: "Poppies Farm, Hurst, RG10 0RS",
  },
];
